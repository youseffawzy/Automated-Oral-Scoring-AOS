            ...
            <div class="table-responsive">
                <table class="table" style="width:100%">
                    <thead style="background:#131d38;color:#fff">
                        <tr>
                            <th  style="text-align:center; padding:25px; width:40%"> All Complete questions</th>
                            <th style="text-align:center; width:35%">
                                <div class="clearfix">
                                    ...
                                    <nav class="navbar navbar-light d-inline" style="background:#131d38;width:50%;align:right;">
                                        <form class="form-inline input-group d-inline"  action="/course/{{$course->code}}/exams/{{$exam->idexam}}/examquestion/completes" method="GET">
                                    ...
                                    <a role="button" class="btn d-inline" href="/course/{{$course->code}}/exams/{{$exam->idexam}}/examquestion/completes/create" style="background-color:#2fb8c0	;color:#fff;margin: 0px 0px;font-size: 16px;padding: 7px 22px;">Add </a>
                                </div> 
                            </th>      
                        </tr>
                    </thead>
        ...
        @if(count($questions)>0)
            <table class="card-body">
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 20px;max-width: 20px;"><h5 class="text-dark text-sm-right" style="margin:5px;position: relative;right: 40px;">Action</h5></th>
                                    </tr>
                    ...
                    <tr>
                                        ...
                                        <td style="min-width: 10px;max-width: 20px;">
                                            <form class="float-right ml-2" action="/course/{{$course->code}}/exams/{{$exam->idexam}}/examquestion/completes/{{$question->id}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a href="/course/{{$course->code}}/exams/{{$exam->idexam}}/examquestion/completes/{{$question->id}}/edit" class="btn btn-primary float-right d-inline">Edit</a>
                                        </td>
                                    </tr>
                    ...
                    <div class="table-responsive">
                        @else
                            <table class="card-body">
                                <thead><tr><th> no have complete questions </th></tr></thead>
                            </table>
                        @endif
                    </div>
            </div>
