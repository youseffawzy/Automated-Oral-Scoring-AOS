...
<div class="card card-default">
    ...
    <div class="card-body">
        <form action="/course/{{$course->code}}/exams/{{$exam->idexam}}" method="POST">
            @csrf
            @if (isset($exam))
                @method('PUT')
            @endif
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                        <input type="number" name="num_of_mcq_n" value="{{ isset($exam) ? $exam->num_of_mcq_n :  old('num_of_mcq_n') }}" class=" @error('num_of_mcq_n') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;right:15px;width:90%;" placeholder="Enter num_Of_normal MCQ" >
                            @error('num_of_mcq_n')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <td>
                        <div class="form-group">
                        <input type="number" name="num_of_mcq_h" value="{{ isset($exam) ? $exam->num_of_mcq_h :  old('num_of_mcq_h') }}" class=" @error('num_of_mcq_h') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;width:90%;" placeholder="Enter num_Of_hard MCQ" >
                            @error('num_of_mcq_h')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="number" name="num_of_match_n" value="{{ isset($exam) ? $exam->num_of_match_n :  old('num_of_match_n') }}" class=" @error('num_of_match_n') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;right:15px;width:90%;" placeholder="Enter num_Of_normal Match" >
                    ...
                    <td>
                        <div class="form-group">
                            <input type="number" name="num_of_match_h" value="{{ isset($exam) ? $exam->num_of_match_h :  old('num_of_match_h') }}" class=" @error('num_of_match_h') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;width:90%;" placeholder="Enter num_Of_hard Match">
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="number" name="num_of_complete_n" value="{{ isset($exam) ? $exam->num_of_complete_n :  old('num_of_complete_n') }}" class=" @error('num_of_complete_n') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;right:15px;width:90%;" placeholder="Enter num_Of_normal Match"  >
                    ...
                    <td>    
                        <div class="form-group">
                            <input type="number" name="num_of_complete_h" value="{{ isset($exam) ? $exam->num_of_complete_h :  old('num_of_complete_h') }}" class=" @error('num_of_complete_h') is-invalid @enderror form-control" style="position:relative;top:5px;float:right;width:90%;" placeholder="Enter num_Of_hard Match" >
