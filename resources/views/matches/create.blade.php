...
<body>
    ...
    <div class="card card-default">
        <div class="card-header">
            {{ isset($match) ? "Update match questions" : "Add a new match question" }}
        </div>
        
            <div class="card-body">
            <form action="/course/{{$course->code}}/exams/{{$exam->idexam}}/examquestion/matches " method="POST">
                @csrf
                @if (isset($question))
                    @method('PUT')
                @endif
                                                ...
                                                <table class="table table-active">
                                                    ...
                                                    <tbody class="t1">                                                         
                                                        <tr>
                                                            <td colspan="3">
                                                                <div class="form-group">
                                                                    <label  type="text" for="exams"  style="color: #0C2543;font-size:100%">degree of defficult</label>
                                                                        <select name="priority"  class="form-control" style="height:30%"  placeholder="degree of defficult"> 
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <label for="match_true_answer" style="color: #0C2543;font-size:100%">question</label>
                                                                        <input type="text" name="question[]"   class=" @error('question') is-invalid @enderror form-control" placeholder="Enter the question "  style="width:100%">  
                                                                            @error('question')
                                                                                <div class="alert alert-danger">
                                                                                    {{ $message }}
                                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <label  type="text" for="answer" style="color: #0C2543;font-size:100%"> answer</label>
                                                                        <input  name="answer[]"  class=" @error('answer') is-invalid @enderror form-control" placeholder="Enter the answer Of question " style="width:100%" > 
                                                                            @error('answer')
                                                                                <div class="alert alert-danger">
                                                                                    {{ $message }}
                                                                                </div>
